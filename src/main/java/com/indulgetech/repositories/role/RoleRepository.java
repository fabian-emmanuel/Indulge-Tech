...
public interface RoleRepository extends JpaRepository<Role, Integer> {
    ...
    @Query("select new com.indulgetech.dto.user.role.ListRoleDto(r.id,r.name,r.description,r.roleType,r.systemCreated) from Role r WHERE r.auditSection.delF <> '1' order by r.name asc")
